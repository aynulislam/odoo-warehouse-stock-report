...
class StockReportWizard(models.TransientModel):
    ...
    def pdf_action(self):
        ...
        return (self.env.ref('mh_stock_report.pdf_stock_report_action').report_action
                (self, data=data))
    ...
    def excel_stock_report_card(self):
        ...
        for move in stock_move:
            ...
            if move.location_dest_id.id == self.stock_location_id.id and move.picking_id.picking_type_id.code in ['incoming', 'internal']:
                        in_qty += move.quantity
            if move.location_id.id == self.stock_location_id.id and move.picking_id.picking_type_id.code in ['outgoing', 'internal']:
