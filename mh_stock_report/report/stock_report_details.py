...
class StockReportDetails(models.AbstractModel):
    ...
    """
    _name = 'report.mh_stock_report.stock_report_template'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        for move in docs:
            ...
            if move.location_dest_id.id == location_id[0] and move.picking_id.picking_type_id.code in ['incoming', 'internal']:
                        in_qty += move.quantity
            if move.location_id.id == location_id[0] and move.picking_id.picking_type_id.code in ['outgoing', 'internal']:
